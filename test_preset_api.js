...
async function testPresetFix() {
    ...
    // Now simulate the servo_pwm preset logic
    // We need to check what the preset application would do
    // The actual preset application happens in the browser, but we can verify
    // the hardware API returns the right PWM resources
