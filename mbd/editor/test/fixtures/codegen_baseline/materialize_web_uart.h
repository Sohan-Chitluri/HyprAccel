...
#define HYP_PIN_SERIALLINK_0_TX "GPIO17"  /* SerialLink[0] → uart.uart2.tx */
#define HYP_PERIPH_SERIALLINK_0_UART_UART2 "uart.uart2"
#define HYP_PIN_SERIALLINK_0_RX "GPIO16"  /* SerialLink[0] → uart.uart2.rx */
#define HYP_PIN_SERVO_0_OUTPUT "GPIO25"  /* Servo[0] → pwm.GPIO25.output */
#define HYP_PERIPH_SERVO_0_PWM_GPIO25 "pwm.GPIO25"

/* Hardware Setup resources — generated from project hardware.json */
#define HYP_RESOURCE_UART_UART2 1
#define HYP_RESOURCE_UART_UART2_BAUD_RATE 57600
#define HYP_RESOURCE_PWM_GPIO25 1
